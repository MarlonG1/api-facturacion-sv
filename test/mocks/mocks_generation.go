...
//go:generate mockgen -destination=./dte_repository_mock.go -package=mocks github.com/MarlonG1/api-facturacion-sv/internal/domain/dte/dte_documents DTERepositoryPort
//go:generate mockgen -destination=./seqnumber_repository_mock.go -package=mocks github.com/MarlonG1/api-facturacion-sv/internal/domain/ports SequentialNumberRepositoryPort
...
//go:generate mockgen -destination=./auth_repository_mock.go -package=mocks github.com/MarlonG1/api-facturacion-sv/internal/domain/auth AuthRepositoryPort
