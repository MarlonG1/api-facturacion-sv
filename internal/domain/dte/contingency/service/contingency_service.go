...
import (
	...
	contingencyPorts "github.com/MarlonG1/api-facturacion-sv/internal/domain/dte/contingency/ports"
	dteInterface "github.com/MarlonG1/api-facturacion-sv/internal/domain/dte/dte_documents/interfaces"
...
type ContingencyService struct {
	...
	dteManager        dteInterface.DTEManager
	repo              contingencyPorts.ContingencyRepositoryPort
	...
	batchTransmitter  batchPorts.BatchTransmitterPort
	contingencyEvents contingencyPorts.ContingencyEventSender
