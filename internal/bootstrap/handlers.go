...
func (c *HandlerContainer) Initialize() {
	...
	c.dteHandler = handlers.NewDTEHandler(c.useCases.InvoiceUseCase(), c.useCases.CCFUseCase(), c.useCases.RetentionUseCase(), c.useCases.CreditNoteUseCase(), c.useCases.DTEConsultUseCase(), c.useCases.InvalidationUseCase(), c.contingencyHandler)
}
