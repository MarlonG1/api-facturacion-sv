...
const docTemplate = `{
        ...
        "/api/v1/dte/retention": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Withholding certificate data",
                        "name": "retention",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_MarlonG1_api-facturacion-sv_pkg_mapper_request_mapper_structs.CreateRetentionRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_MarlonG1_api-facturacion-sv_pkg_mapper_request_mapper_structs.CreateRetentionRequest": {
            "type": "object",
            "properties": {
                "appendixes": {
                    "type": "array",
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/github_com_MarlonG1_api-facturacion-sv_pkg_mapper_request_mapper_structs.RetentionItem"
                    }
                },
                "receiver": {
                    "$ref": "#/definitions/github_com_MarlonG1_api-facturacion-sv_pkg_mapper_request_mapper_structs.ReceiverRequest"
                ...
                "summary": {
                    "$ref": "#/definitions/github_com_MarlonG1_api-facturacion-sv_pkg_mapper_request_mapper_structs.RetentionSummary"
                }
            }
        },
        ...
        "github_com_MarlonG1_api-facturacion-sv_pkg_mapper_request_mapper_structs.RetentionItem": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "github_com_MarlonG1_api-facturacion-sv_pkg_mapper_request_mapper_structs.RetentionSummary": {
            "type": "object",
            "properties": {
